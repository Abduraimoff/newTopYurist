  ...
  void didChangeDependencies() {
    data = ModalRoute.of(context)?.settings.arguments == null
        ...
        : ModalRoute.of(context)?.settings.arguments
            as UserHomeRequestListResponse;
    if(data != null){
            ...
            listener: (context, state) {
              if (state is ApplicationCreatedSuccessfullyState) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text("Your application successfully created"),
                  ),
                );
              }
            },
                        ...
                        builder: (context, state) {
                          ...
                          return DropdownButtonFormField<RegionsResponse>(
                            decoration: InputDecoration(
                              ...
                              hintText: data?.problemType?.ruRu ??
                                  context.localeString('select_category_request'),
                      ...
                      child: TextButton(
                        onPressed: () {
                          if (selectedCategory == null ||
                            ...
                            if ((_controller?.text.length ?? 0) < 15) {
                              setState(() {
